...
"すべて手元のPCで生成":"全部在手邊的電腦生成","外に出ない":"不外流",
"11 — ローカル生成":"11 — 本地生成","生成は、ぜんぶ、":"生成，全部都","この手元":"在這手邊",
"クラウドに送って作るのではなく、スタジオそのものが手元のマシンに入っている。":"不是送上雲端才能生成，而是整間工作室都裝進你手邊的機器裡。",
"素材も、途中の失敗も、完成した一本も——ここから外へは出ない。":"素材、中途的失敗、完成的那一支——都不會離開這裡。",
"外に出ないから、自由":"因為不外流，所以自由",
"素材も途中経過も、ネットの向こうへ送らない。だから誰にも気兼ねなく、最後まで作り切れる。":"素材與過程，都不送往網路的另一端。所以無須顧慮任何人，能一路做到最後。",
"何度でも、納得するまで":"想重來幾次，就重來幾次",
"生成のたびの追加費用がない。失敗のコストは時間だけ——「もう一回」を、ためらわない。":"每次生成都沒有額外費用。失敗的成本只有時間——「再來一次」，不必猶豫。",
"失敗も、財産になる":"連失敗，都成為資產",
"やり直したテイクは流れて消えず、手元に積み上がる。次の一本が、その分だけ賢くなる。":"重做的每一個鏡頭都不會流走消失，而是留在手邊累積。下一支作品，也因此更聰明。",
"眠っている間も、働く":"連你睡著時，也在工作",
"生成の列は夜のあいだも自動で進む。朝には、選ぶだけの状態が待っている。":"生成的隊列在夜裡也自動前進。到了早上，只剩挑選的工作在等你。",
"手元で生まれた素材":"在手邊誕生的素材","完成作品の上映時間":"完成作品的總片長","58分":"58分鐘",
"生成ごとの追加費用":"每次生成的額外費用","0円":"0元","手元のマシンで完結":"在手邊的機器完結",
"14 — 裏番組":"14 — 幕後節目","上映のあとも、":"放映結束後，","番組":"節目","は続く。":"仍在繼續。",
"完成した一本の裏には、山ほどの失敗と、やり直しの夜がある。":"每一支完成的作品背後，都有堆積如山的失敗，與重來的漫漫長夜。",
"それを隠さずに、番組にした——作られた本人、RINKAが話す。":"我們不加掩飾，把它做成了節目——由被做出來的本人，RINKA親口來說。",
"ラジオ":"廣播","解説":"解說",
"RINKAのオフレコ #01":"RINKA的悄悄話 #01",
"見張りが自分を見張って、朝まで止まっていた——監督のいないところで話す、制作裏話。":"看門的小幫手整晚在看自己，一路停到天亮——在導演不在的地方，聊製作的幕後。",
"AIが自分の作られ方を話す":"AI親自說自己是怎麼做出來的",
"6本のMVの舞台裏を、AI本人がまとめて解説する。":"六支MV的幕後，由AI本人一次說明。",
"『約束』制作全記録":"『約束』製作全紀錄",
"697枚から選ばれた彼女が、ボツになった50本ぶんの失敗を自分で話す。":"從697張候選中被選出的她，親口說出被捨棄的50支失敗。",
