...
(function dotsNav(){
  ...
  const NAV=[['00','はじめに','.hero'],['01','問い','[data-ch="01"]'],['02','相談','[data-ch="02"]'],
    ...
    ['14a','三つのスタジオ','[data-ch="14a"]'],['15a','導入','[data-ch="15a"]'],['10','はじめる','.closing']];
...
"14 — 三つのスタジオ":"14 — 三間工作室","ひとつの相棒、":"一個夥伴，","三つのスタジオ":"三間工作室","。":"。","MVも、写真も、音楽も——制作は、ひとつの対話から。":"MV、照片、音樂——創作，都從同一場對話開始。","いま、三つのスタジオを育てています。":"現在，我們正在培育三間工作室。","一本のMVを、対話で設計する。物語、絵コンテ、カット割り、人物、カメラの動き、全体の風格まで——迷いなく、完成へ向かう。":"透過對話與諮詢，一步一步規劃一支MV——劇情、分鏡、鏡頭、角色、運鏡與整體風格，讓製作不再迷惘，直向完成。","プロの撮影現場を、手元に。テーマ、光、構図、カメラ位置、ポーズ、衣装、メイク——本物の撮影の流れで、一枚を仕上げる。":"以專業攝影為核心。主題、燈光、構圖、鏡位、姿勢、服裝、妝容——以真實的攝影工作流程，完成一張作品。","音楽づくりを、ひとつながりに。作詞・作曲・編曲の方向づくりから、歌い方の設計まで——頭の中の曲が、かたちになる。":"透過對話整理創作想法。從作詞、作曲、編曲的方向規劃，到歌唱風格設計——讓腦海中的曲子，一步步成形。",
