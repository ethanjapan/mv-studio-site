  ...
  fragmentShader:`
    ...
    void main(){
      ...
      if(gl_FrontFacing){
        ...
        col=uwEnv(Dn,L,col,u_uwMap,u_uwVid*smoothstep(0.035,0.15,Dn.y));
...
matteVideo.src='assets/bg_aurora.mp4?v=20260704c';
...
const dayTex=new THREE.TextureLoader().load('assets/bg_daysky.jpg?v=20260704c');
...
poolVideo.src='assets/bg_pool.mp4?v=20260704c';
...
uwVideo.src='assets/bg_underwater.mp4?v=20260704c';
